...
namespace MainScene.Repository
{
    public class OrderRepository
    {
        public List<Order> GetOrderHistoryList()
        {
            ...
            tempOrderList.Add(new Order(1, true, new Table(), new Payment(true, "11", DateTime.Now), products));
            tempOrderList.Add(new Order(1, true, new Table(), new Payment(true, "11", DateTime.Now), new List<Product>()));
            tempOrderList.Add(new Order(1, true, new Table(), new Payment(true, "11", DateTime.Now), new List<Product>()));
            tempOrderList.Add(new Order(1, true, new Table(), new Payment(true, "11", DateTime.Now), new List<Product>()));
